    ...
    var __webpack_modules__ = [
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          class PDFObjects {
            ...
            #o(t) {
              const e = this.#a[t];
              return (
                e || (this.#a[t] = { capability: (0, _util.createPromiseCapability)(), data: null })
              );
            }
            get(t, e = null) {
              if (e) {
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorUIManager {
            ...
            updateToolbar(t) {
              t !== this.#O &&
                this.#R.dispatch("switchannotationeditormode", { source: this, mode: t });
            }
            updateParams(t, e) {
        ...
        (t, e, s) => {
          ...
          class FreeTextEditor extends r.AnnotationEditor {
            ...
            constructor(t) {
              ...
              this.#vt =
                t.color || FreeTextEditor._defaultColor || r.AnnotationEditor._defaultLineColor;
              this.#Et = t.fontSize || FreeTextEditor._defaultFontSize;
            }
            static initialize(t) {
              this._l10nPromise = new Map(
                ["free_text_default_content", "editor_free_text_aria_label"].map((e) => [
                  e,
                  t.get(e),
                ])
              );
        ...
        (t) => {
          ...
          function newtonRaphsonRootFind(t, e, s) {
            var n = maths.subtract(bezier.q(t, s), e),
              ...
              a =
                maths.sum(maths.squareItems(i)) + 2 * maths.mulMatrix(n, bezier.qprimeprime(t, s));
            return 0 === a ? s : s - r / a;
          }
          ...
          t.exports = function fitCurve(t, e, s) {
            ...
            if (
              (t = t.filter((e, s) => 0 === s || !e.every((e, n) => e === t[s - 1][n]))).length < 2
            )
              return [];
            const n = t.length,
        ...
        (t, e, s) => {
          ...
          e.XfaLayer = class XfaLayer {
            ...
            static render(t) {
              ...
              i.attributes &&
                this.setAttributes({ html: a, element: i, intent: r, linkService: s });
              const o = [[i, -1, a]],
                l = t.div;
              l.append(a);
              if (t.viewport) {
