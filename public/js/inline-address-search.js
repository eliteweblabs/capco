...
export function initializeAddressSearch(config) {
    const { id, fetchApiEndpoint = "/api/google/places-autocomplete", apiParams = {}, valueField = "description", labelField = "description", onSelect, } = config;
    ...
    function createResultElement(result, index, isSelected = false) {
        ...
        li.className = `inline-address-result-item cursor-pointer px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 ${isSelected
    ...
    resultsList.addEventListener("click", (e) => {
        ...
        if (li) {
            ...
            window.dispatchEvent(new CustomEvent("inline-address-select", {
                detail: {
                    componentId: id,
                    value,
                    label,
