export const globalClasses = () => {
  return {
    ...
    multiStepInputClasses:
      "w-full shadow-primary-inner-md bg-transparent text-xl sm:text-2xl md:text-3xl border-0 py-2.5 px-4 text-gray-900 transition-colors duration-200 placeholder:text-gray-500 focus:outline-none dark:text-white dark:placeholder:text-gray-400 no-scrollbar text-left",
