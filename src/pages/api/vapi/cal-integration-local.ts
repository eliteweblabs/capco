...
/**
 * Vapi.ai Cal.com Integration API (Local Instance)
 *
 * Handles Vapi.ai webhook calls for local Cal.com operations
...
export const POST: APIRoute = async ({ request, cookies }) => {
  try {
    ...
    console.log(`🤖 [VAPI-CAL-LOCAL] ${action} ${type} request:`, {
      appointmentId,
      userId,
      eventTypeId,
    });
    ...
    console.error("❌ [VAPI-CAL-LOCAL] Error:", error);
