...
//
// Company name slug is generated from RAILWAY_PROJECT_NAME or globalSettings.companyName
...
export const UNIFIED_FORM_ELEMENTS: FormElementConfig[] = [
...

  {
    ...
    elementType: "button",
    label:
      "<span class='hidden sm:block md:hidden'>Delete</span><span class='hidden md:block'>Delete Project</span>",
    icon: "trash",
    variant: "danger",
      ...
      .map((element) => {
        if (element.id === "save-project") {
          return {
            ...element,
            label:
              "<span class='hidden sm:block'>Create Project</span><span class='block sm:hidden'>Create</span>",
