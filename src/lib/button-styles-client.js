// Client-side button styling that mirrors the server-side logic
// This file is kept in sync with button-styles.ts
...
export function generateButtonHTML(text, config = {}, dataAttributes = {}) {
