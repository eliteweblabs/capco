...
export interface FormStepConfig {
  /** 1-based step index. Auto-assigned from array position if omitted (preferred). */
  stepNumber?: number;
  title: string;
  subtitle?: string;
  ...
  // Animation effects
  effect?: "typewriter" | "none"; // Text animation effect for title (defaults to "typewriter")
