...
const standardFonts: FontOption[] = [
  ...
  },
  {
    value: "Poppins",
    label: "Poppins",
    googleUrl: "https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap",
  },
  {
    value: "Inter",
    label: "Inter",
    googleUrl: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700&display=swap",
  },
  {
    value: "Raleway",
    label: "Raleway",
    googleUrl: "https://fonts.googleapis.com/css2?family=Raleway:wght@300;400;600;700&display=swap",
  },
  {
  ...
  },
  {
    value: "Nunito",
    label: "Nunito",
    googleUrl: "https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;600;700&display=swap",
  },
  {
  ...
  },
  {
    value: "Oswald",
    label: "Oswald",
    googleUrl: "https://fonts.googleapis.com/css2?family=Oswald:wght@300;400;600;700&display=swap",
  },
  {
    value: "Lora",
    label: "Lora",
    googleUrl: "https://fonts.googleapis.com/css2?family=Lora:wght@400;700&display=swap",
  },
  {
    value: "PT Sans",
    label: "PT Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=PT+Sans:wght@400;700&display=swap",
  },
  {
    value: "Ubuntu",
    label: "Ubuntu",
    googleUrl: "https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;700&display=swap",
  },
  {
    value: "Noto Sans",
    label: "Noto Sans",
  ...
  },
  {
    value: "Crimson Text",
    label: "Crimson Text",
    googleUrl: "https://fonts.googleapis.com/css2?family=Crimson+Text:wght@400;700&display=swap",
  },
  {
    value: "Fira Sans",
    label: "Fira Sans",
  ...
  },
  {
    value: "Rubik",
    label: "Rubik",
    googleUrl: "https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;600;700&display=swap",
  },
  {
    value: "Josefin Sans",
    label: "Josefin Sans",
  ...
  },
  {
    value: "Dosis",
    label: "Dosis",
    googleUrl: "https://fonts.googleapis.com/css2?family=Dosis:wght@300;400;600;700&display=swap",
  },
  {
    value: "Arvo",
    label: "Arvo",
    googleUrl: "https://fonts.googleapis.com/css2?family=Arvo:wght@400;700&display=swap",
  },
  {
    value: "Titillium Web",
    label: "Titillium Web",
  ...
  },
  {
    value: "Mukta",
    label: "Mukta",
    googleUrl: "https://fonts.googleapis.com/css2?family=Mukta:wght@300;400;600;700&display=swap",
  },
  {
    value: "Karla",
    label: "Karla",
    googleUrl: "https://fonts.googleapis.com/css2?family=Karla:wght@300;400;600;700&display=swap",
  },
  {
    value: "Barlow",
    label: "Barlow",
    googleUrl: "https://fonts.googleapis.com/css2?family=Barlow:wght@300;400;600;700&display=swap",
  },
  {
    value: "DM Sans",
    label: "DM Sans",
    googleUrl: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;700&display=swap",
  },
  {
    value: "Manrope",
    label: "Manrope",
    googleUrl: "https://fonts.googleapis.com/css2?family=Manrope:wght@300;400;600;700&display=swap",
  },
  {
    value: "Space Grotesk",
    label: "Space Grotesk",
...
const handwrittenFonts: FontOption[] = [
  ...
  },
  {
    value: "Caveat",
    label: "Caveat",
    googleUrl: "https://fonts.googleapis.com/css2?family=Caveat:wght@400;700&display=swap",
    handwritten: true,
  },
  {
    value: "Permanent Marker",
    label: "Permanent Marker",
    googleUrl: "https://fonts.googleapis.com/css2?family=Permanent+Marker&display=swap",
    handwritten: true,
  },
  {
    value: "Satisfy",
    label: "Satisfy",
    googleUrl: "https://fonts.googleapis.com/css2?family=Satisfy&display=swap",
    handwritten: true,
  },
  {
    value: "Great Vibes",
  ...
  },
  {
    value: "Sacramento",
    label: "Sacramento",
    googleUrl: "https://fonts.googleapis.com/css2?family=Sacramento&display=swap",
    handwritten: true,
  },
  {
    value: "Kalam",
    label: "Kalam",
    googleUrl: "https://fonts.googleapis.com/css2?family=Kalam:wght@300;400;700&display=swap",
    handwritten: true,
  },
  {
    value: "Patrick Hand",
  ...
  },
  {
    value: "Caveat Brush",
    label: "Caveat Brush",
    googleUrl: "https://fonts.googleapis.com/css2?family=Caveat+Brush&display=swap",
    handwritten: true,
  },
  {
    value: "Shadows Into Light",
    label: "Shadows Into Light",
    googleUrl: "https://fonts.googleapis.com/css2?family=Shadows+Into+Light&display=swap",
    handwritten: true,
  },
  {
    value: "Indie Flower",
    label: "Indie Flower",
    googleUrl: "https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap",
    handwritten: true,
  },
];

/** All fonts for primary select (standard + handwritten, excluding Dancing Script from standard since it's in handwritten) */
const primaryFonts = [...standardFonts, ...handwrittenFonts];

/** Fonts for secondary/tertiary (add system options) */
const secondaryAndTertiaryFonts = [...systemFonts, ...primaryFonts];
