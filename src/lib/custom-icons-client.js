// Custom icon system - Client-side JavaScript version
// Direct SVG HTML mapping with no external dependencies
...
// Base SVG template
function createSVG(icon, config = {}) {
...
export function getIconHTML(name, size = 16, className = "") {
