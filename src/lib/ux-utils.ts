      ...
      <div class="relative max-h-full w-full ${sizeClasses[size]} p-4">
        <div id="${id}-content" class="relative rounded-lg bg-white shadow dark:bg-gray-800">
          ...
          <div class="flex items-center justify-end gap-2 rounded-b border-t border-gray-200 p-4 dark:border-gray-600 md:p-5" id="${id}-footer">
            ...
            <button
              type="button"
              class="rounded-lg bg-primary-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-600 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-500 dark:hover:bg-primary-600 dark:focus:ring-primary-800"
              id="${id}-confirm-btn"
            ></button>
          </div>
        </div>
