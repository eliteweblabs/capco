...
export const blockRegistry: Record<string, BlockDefinition> = {
  CTABlock: {
    ...
    props: {
      ...
      variant: { type: 'string', default: 'centered', description: 'Layout variant: centered, left, split, gradient' },
  ...
  FeatureGridBlock: {
    ...
    props: {
      ...
      features: { type: 'string', description: 'JSON array of features [{icon, title, description}]' },
  ...
  FAQBlock: {
    ...
    props: {
      title: { type: 'string', description: 'Section title' },
      description: { type: 'string', description: 'Section description' },
      variant: { type: 'string', default: 'accordion', description: 'Style: accordion, grid, simple' },
      // FAQs as JSON
  ...
  ContentBlock: {
    ...
    props: {
      ...
      imagePosition: { type: 'string', default: 'right', description: 'Image position: left, right, top, bottom' },
  ...
  TimelineBlock: {
    ...
    props: {
      title: { type: 'string', description: 'Section title' },
      description: { type: 'string', description: 'Section description' },
      variant: { type: 'string', default: 'vertical', description: 'Layout: vertical, horizontal, alternating' },
      steps: { type: 'string', description: 'JSON array of steps [{title, description, icon, date}]' },
    }
  },
  ...
  NewsletterBlock: {
    ...
    props: {
      ...
      placeholder: { type: 'string', default: 'Enter your email', description: 'Input placeholder' },
  ...
  AlertBlock: {
    ...
    props: {
      ...
      variant: { type: 'string', default: 'info', description: 'Type: info, success, warning, danger' },
  ...
  PricingBlock: {
    ...
    props: {
      title: { type: 'string', description: 'Section title' },
      description: { type: 'string', description: 'Section description' },
      variant: { type: 'string', default: 'cards', description: 'Style: cards, comparison, simple' },
  ...
  FooterBlock: {
    ...
    props: {
      variant: { type: 'string', default: 'standard', description: 'Style: standard, minimal, centered' },
...
export const getBlockDefinition = (name: string): BlockDefinition | undefined => blockRegistry[name];
