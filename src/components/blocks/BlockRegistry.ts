...
export const blockRegistry: Record<string, BlockDefinition> = {
  ...
  TabberBlock: {
    ...
    props: {
      tabs: { type: "string", description: "JSON array [{label, content, icon?}]" },
      tab1Label: { type: "string" },
      tab1Content: { type: "string" },
      tab1Icon: { type: "string" },
      tab1ButtonText: { type: "string" },
      tab1ButtonHref: { type: "string" },
      tab1ButtonVariant: { type: "string" },
      tab2Label: { type: "string" },
      tab2Content: { type: "string" },
      tab2Icon: { type: "string" },
      tab2ButtonText: { type: "string" },
      tab2ButtonHref: { type: "string" },
      tab2ButtonVariant: { type: "string" },
      tab3Label: { type: "string" },
      tab3Content: { type: "string" },
      tab3Icon: { type: "string" },
      tab3ButtonText: { type: "string" },
      tab3ButtonHref: { type: "string" },
      tab3ButtonVariant: { type: "string" },
      tab4Label: { type: "string" },
      tab4Content: { type: "string" },
      tab4Icon: { type: "string" },
      tab4ButtonText: { type: "string" },
      tab4ButtonHref: { type: "string" },
      tab4ButtonVariant: { type: "string" },
      tab5Label: { type: "string" },
      tab5Content: { type: "string" },
      tab5Icon: { type: "string" },
      tab5ButtonText: { type: "string" },
      tab5ButtonHref: { type: "string" },
      tab5ButtonVariant: { type: "string" },
      tab6Label: { type: "string" },
      tab6Content: { type: "string" },
      tab6Icon: { type: "string" },
      tab6ButtonText: { type: "string" },
      tab6ButtonHref: { type: "string" },
      tab6ButtonVariant: { type: "string" },
      compact: { type: "boolean", description: "Compact nav layout" },
    },
  },

  IconTooltip4Block: {
    name: "IconTooltip4Block",
    description: "4-column XL icon grid; text in tooltips on hover/tap",
    props: {
      items: {
        type: "string",
        description: "JSON array [{icon, title, description}]",
      },
      item1Icon: { type: "string" },
      item1Title: { type: "string" },
      item1Description: { type: "string" },
      item2Icon: { type: "string" },
      item2Title: { type: "string" },
      item2Description: { type: "string" },
      item3Icon: { type: "string" },
      item3Title: { type: "string" },
      item3Description: { type: "string" },
      item4Icon: { type: "string" },
      item4Title: { type: "string" },
      item4Description: { type: "string" },
    },
  },
