-- Add navigation properties to cmsPages table
...
COMMENT ON COLUMN cmsPages.nav_button_style IS 'Optional button style for navigation: primary, secondary, ghost, outline';
COMMENT ON COLUMN cmsPages.nav_desktop_only IS 'If true, show only on desktop navigation';
COMMENT ON COLUMN cmsPages.nav_hide_when_auth IS 'If true, hide this navigation item when user is authenticated';
