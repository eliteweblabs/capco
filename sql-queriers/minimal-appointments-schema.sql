-- Minimal Appointments Schema for Vapi.ai Integration
-- This creates just the appointments table without complex dependencies

-- Create appointments table (minimal version)
