-- PDF System Database Tables
-- Creates tables for PDF templates and generation system
...
CREATE TABLE IF NOT EXISTS pdfGenerationJobs (
  id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS pdfTemplateFields (
  id SERIAL PRIMARY KEY,
  templateId INTEGER REFERENCES pdfTemplates(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS pdfGenerationHistory (
  id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_pdf_templates_author ON pdfTemplates(authorId);
CREATE INDEX IF NOT EXISTS idx_pdf_templates_project ON pdfTemplates(projectId);
CREATE INDEX IF NOT EXISTS idx_pdf_templates_type ON pdfTemplates(templateType);
CREATE INDEX IF NOT EXISTS idx_pdf_templates_active ON pdfTemplates(isActive);
CREATE INDEX IF NOT EXISTS idx_pdf_generation_jobs_status ON pdfGenerationJobs(status);
CREATE INDEX IF NOT EXISTS idx_pdf_generation_jobs_project ON pdfGenerationJobs(projectId);
CREATE INDEX IF NOT EXISTS idx_pdf_template_fields_template ON pdfTemplateFields(templateId);
