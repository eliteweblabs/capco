...
BEGIN
    ...
    base_time := NOW();
     ...
     VALUES 
     (project_id_param, '96b2ea01-0b06-4a2d-9048-d26eeaf97217', 'Receive CAD files from client / download from <a class="text-primary dark:text-primary-text" href="{{SITE_URL}}/project/{{PROJECT_ID}}?status=documents">Documents</a>', false, false, 'CAPCo Fire', base_time + INTERVAL '1 second'),
     ...
     (project_id_param, '96b2ea01-0b06-4a2d-9048-d26eeaf97217', 'Print drawings to PDF for submittal / upload to <a class="text-primary dark:text-primary-text" href="{{SITE_URL}}/project/{{PROJECT_ID}}?status=deliverables">Deliverables</a>', false, false, 'CAPCo Fire', base_time + INTERVAL '11 seconds');
