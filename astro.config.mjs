...
export default defineConfig({
  ...
  vite: {
    ...
    define: {
      ...
      "process.env.SQUARE_APPLICATION_ID": JSON.stringify(env.SQUARE_APPLICATION_ID || ""),
      "process.env.SQUARE_LOCATION_ID": JSON.stringify(env.SQUARE_LOCATION_ID || ""),
      "process.env.SQUARE_ENVIRONMENT": JSON.stringify(env.SQUARE_ENVIRONMENT || "sandbox"),
