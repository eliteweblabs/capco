...
ARG YEAR
ARG PRIMARY_COLOR
ARG GLOBAL_PRIMARY_TEXT_CLASSES
ARG GLOBAL_SECONDARY_TEXT_CLASSES
ARG EMAIL_LOGO_LIGHT
ARG SECONDARY_COLOR
ARG PRIMARY_COLOR_RGB
ARG GLOBAL_INPUT_CLASSES
ARG GLOBAL_SECONDARY_TEXT_CLASSES
...
ENV YEAR=$YEAR
ENV GLOBAL_PRIMARY_TEXT_CLASSES=$GLOBAL_PRIMARY_TEXT_CLASSES
ENV GLOBAL_SECONDARY_TEXT_CLASSES=$GLOBAL_SECONDARY_TEXT_CLASSES
ENV EMAIL_LOGO_LIGHT=$EMAIL_LOGO_LIGHT
ENV SECONDARY_COLOR=$SECONDARY_COLOR
ENV PRIMARY_COLOR_RGB=$PRIMARY_COLOR_RGB
ENV GLOBAL_INPUT_CLASSES=$GLOBAL_INPUT_CLASSES
ENV GLOBAL_SECONDARY_TEXT_CLASSES=$GLOBAL_SECONDARY_TEXT_CLASSES
...
# RUN echo "SECONDARY_COLOR: $SECONDARY_COLOR"
# RUN echo "PRIMARY_COLOR_RGB: $PRIMARY_COLOR_RGB"
