...
# RAILWAY_PROJECT_NAME: Railway injects at runtime; omit from build unless you need it inlined in client bundle
ARG YEAR
...
# Company Branding (RAILWAY_PROJECT_NAME provided by Railway at runtime)
...
ENV PUBLIC_GOOGLE_MAPS_API_KEY=${PUBLIC_GOOGLE_MAPS_API_KEY:-$GOOGLE_PLACES_API_KEY}
